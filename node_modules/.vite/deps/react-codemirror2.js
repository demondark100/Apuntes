...
var require_dist2 = __commonJS({
  "node_modules/@codemirror/view/dist/index.cjs"(exports) {
    ...
    function computeCompositionDeco(view, changes) {
      ...
      let { state: state2 } = view, reader = new DOMReader([], state2);
      if (node.nodeType == 3)
      ...
      if (newTo - newFrom < text.length) {
        if (state2.doc.sliceString(newFrom, Math.min(state2.doc.length, newFrom + text.length)) == text)
          newTo = newFrom + text.length;
        else if (state2.doc.sliceString(Math.max(0, newTo - text.length), newTo) == text)
          newFrom = newTo - text.length;
        else
          return Decoration.none;
      } else if (state2.doc.sliceString(newFrom, newTo) != text) {
        return Decoration.none;
      }
    ...
    var EditorView = class {
      ...
      */
      ...
      dispatch(...input) {
        let tr = input.length == 1 && input[0] instanceof state.Transaction ? input[0] : this.state.update(...input);
...
var require_dist8 = __commonJS({
  "node_modules/@codemirror/search/dist/index.cjs"(exports) {
    ...
    var elt__default = _interopDefaultLegacy(elt);
    ...
    var SearchPanel = class {
      constructor(view2) {
        ...
        this.dom = elt__default["default"]("div", { onkeydown: (e) => this.keydown(e), class: "cm-search" }, [
          ...
          elt__default["default"]("label", null, [this.wordField, phrase(view2, "by word")]),
