...
not: contrario`}/>
        ...
        <Python codigo={`#para salir lava los platos y limpia la casa`}/>
...
Como te das cuenta tienen que cumplirse ambos para que puedas salir.`}/>
        ...
        <Python codigo={`#limpia la casa o lava los platos`}/>
