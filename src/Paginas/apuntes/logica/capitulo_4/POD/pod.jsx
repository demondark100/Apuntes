  ...
  return (  
    <>
      ...
      <main>
        ...
        <JavaScropt codigo={`objeto jugador:
...
objeto enemigo:
  ...
  daño: cantidad de daño`}/>
        <h3>ahora</h3>
        <JavaScropt codigo={`Clase Jugador:
  vida: cantidad de vida
Clase Enemigo:
  vida: cantidad de vida,
  daño: cantidad de daño`}/>
        ...
        <JavaScropt codigo={`Clase Persona:
    Propiedad nombre
    Propiedad edad
    Propiedad direccion`}/>
        <h2>Metodos</h2>
  ...
  Metodo Frenar():
    // escribir codigo`}/>
        ...
        <h3>funcion</h3>
        <JavaScropt codigo={`funcion Acelerar(cantidad):
  // escribir contenido`}/>
        <h3>metodos</h3>
        <JavaScropt codigo={`Clase Coche:
...
edadPersona = nueva Persona.MostrarEdad(15);`}/>
        ...
        <JavaScropt codigo={`// Definición de la clase "Persona"
Clase Persona:
    Propiedad nombre
    Propiedad edad
    Propiedad direccion
...
mostrar ("Dirección: " + direccion)`}/>
        ...
        <JavaScropt codigo={`// Definición de la clase "Vehiculo"
Clase Vehiculo:
    Propiedad marca
    Propiedad modelo
...
coche1.obtenerInformacion()`}/>
        ...
        <JavaScropt codigo={`// Definición de la clase "Coche"
Clase Coche:
    Propiedad marca
    Propiedad modelo
    Propiedad color
